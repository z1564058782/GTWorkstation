 ...
 */
public class WorkStation extends TTMultiblockBase implements ISurvivalConstructable, INEIPreviewModifier {
    ...
    private static final IStructureDefinition<WorkStation> STRUCTURE_DEFINITION =
        StructureDefinition.<WorkStation>builder()
            ...
            .addElement('B', WorkStationUtil.ofBlockAdder(WorkStation::addCable, GregTechAPI.sSpaceElevatorCable, 0))
            .addElement(
                'X',
                classicHatches(CASING_INDEX_BASE, 1, GregTechAPI.sBlockCasingsSE, 0))
            .addElement(
                'M',
                HatchElementBuilder.<WorkStation>builder()
            ...
            .addElement(
                ...
                GTStructureChannels.SE_MOTOR.use(StructureUtility.ofBlocksTiered(
                    WorkStationUtil.motorTierConverter(),
                    WorkStationUtil.getMotorTiers(),
                    0,
                    WorkStation::setMotorTier,
                    WorkStation::getMotorTier))) // Motors
            ...
            .addElement(
                'I',
                HatchElementBuilder.<WorkStation>builder()
                    .atLeast(WorkStationUtil.ProjectModuleElement.ProjectModule)
                    .casingIndex(CASING_INDEX_BASE)
                    .hint(2)
    ...
    public enum ElevatorHatchElement implements IHatchElement<WorkStation> {
        ...
        IgnoredHatch(WorkStation::ignoreAndAcceptHatch, MTEHatch.class) {

            @Override
            public long count(WorkStation tileEntity) {
                return 0;
            }
        };

        private final List<Class<? extends IMetaTileEntity>> mteClasses;
        private final IGTHatchAdder<WorkStation> adder;

        @SafeVarargs
        ElevatorHatchElement(IGTHatchAdder<WorkStation> adder,
        ...
        @Override
        public IGTHatchAdder<? super WorkStation> adder() {
            return adder;
        }
    }
     ...
     */
    public WorkStation(int aID, String aName, String aNameRegional) {
     ...
     * @param aName Name of the controller
     */
    protected WorkStation(String aName) {
        super(aName);
        useLongPower = true;
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new WorkStation(this.mName);
    }
    ...
    public void checkMachine(IGregTechTileEntity aBaseMetaTileEntity, ItemStack aStack, List<StructureError> errors) {
        ...
        if (WorkStationUtil.getModuleSlotsUnlocked(motorTier) < mProjectModuleHatches.size()) {
                        ...
                        if (player instanceof EntityPlayerMP playerBase) {
                            ...
                            try {
                                WorldUtil.toCelestialSelection(
                                    playerBase,
                                    stats,
                                    WorkStationUtil.getPlanetaryTravelTier(motorTier),
