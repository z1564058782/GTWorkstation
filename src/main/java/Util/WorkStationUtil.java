...
public class WorkStationUtil {
     ...
     * @author minecraft7771
     */
    public enum ProjectModuleElement implements IHatchElement<WorkStation> {

        ProjectModule(WorkStation::addProjectModuleToMachineList, TileEntityModuleBase.class) {
        ...
        @SafeVarargs
        ProjectModuleElement(IGTHatchAdder<WorkStation> adder,
