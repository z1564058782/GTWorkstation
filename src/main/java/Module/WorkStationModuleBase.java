 ...
 */
public abstract class WorkStationModuleBase extends TTMultiblockBase {
    ...
    private static final INameFunction<WorkStationModuleBase> ENERGY_DISPLAY_NAME = (base, p) -> GTUtility
        .translate("gt.blockmachines.multimachine.project.ig.cfgo.0"); // Stored Energy
    /** Status of the stored energy display */
    private static final IStatusFunction<WorkStationModuleBase> ENERGY_STATUS = (base, p) -> LedStatus
    ...
    private static final IStructureDefinition<WorkStationModuleBase> STRUCTURE_DEFINITION = StructureDefinition
        .<WorkStationModuleBase>builder()
        .addShape(
        ...
        .addElement(
            ...
            GTStructureUtility.ofHatchAdderOptional(
                WorkStationModuleBase::addClassicToMachineList,
                WorkStation.CASING_INDEX_BASE,
                1,
     ...
     */
    protected WorkStationModuleBase(int aID, String aName, String aNameRegional, int tTier, int tModuleTier,
                                   int tMinMotorTier) {
     ...
     * @param tMinMotorTier Minimum needed motor tier
     */
    protected WorkStationModuleBase(String aName, int tTier, int tModuleTier, int tMinMotorTier) {
        super(aName);
        this.tTier = tTier;
        this.tModuleTier = tModuleTier;
        this.tMinMotorTier = tMinMotorTier;
    ...
    WorkStation parent = null;

    public void connect(WorkStation parent) {
        this.parent = parent;
        isConnected = true;
    }
    ...
    public ITexture getCasingTexture() {
        return Textures.BlockIcons.getCasingTextureForId(WorkStation.CASING_INDEX_BASE);
    }
